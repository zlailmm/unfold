...
//                    create_connect(this, last_T[j], return_v, base);
                    ...
                    Add_Arc(last_T[j], return_P, Exp, false, data,normal);
                    Add_Arc(return_P, last_T[j], Exp, true, data,normal);
...
void CPN::Add_Arc(string source, string target, string exp, bool sourceP, Arc_Type arcType, AddArcForm form) {
    ...
    if(form == append) {
        ...
        if(aa == NULL) {
            throw "appendArc should have exist!";
//            aa = &arc[arccount++];
...
//            }
        ...
        if(aa == NULL){
            ...
            throw "normal Add_arc should be unique!";
    }
}
